        ...
        MediaManager.get().upload(imageUri)
                .callback(new UploadCallback() {
                    ...
                    public void onError(String requestId, ErrorInfo error) {
                        Toast.makeText(CamerasAvailable.this,
    ...
    private void saveCameraDataToFirebase(String imageUrl) {
        ...
        FirebaseDatabase.getInstance().getReference("cameras")
                ...
                .addOnSuccessListener(aVoid -> {
                    Toast.makeText(CamerasAvailable.this, "Kamera berhasil disimpan!", Toast.LENGTH_SHORT).show();
                    finish(); // Tutup activity setelah sukses
                })
                .addOnFailureListener(e -> {
                    Toast.makeText(CamerasAvailable.this, "Gagal menyimpan ke database: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
    }
}